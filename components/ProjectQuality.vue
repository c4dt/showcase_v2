<template>
  <div data-testid="project-quality" class="border border-[#707070] px-2 py-1">
    ...
    <div class="grid grid-cols-2 items-center gap-x-[calc(25%)]">
      ...
      <template v-for="tag in statusTags" :key="tag">
        ...
        <FontAwesomeIcon
          :data-testid="tag.dataTestid"
          :icon="tag.label"
          :class="`cursor-help text-xl ${tag.color}`"
          :title="tag.title"
        />
      </template>
    </div>
