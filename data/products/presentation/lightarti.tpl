...
there is a tendency to collect as much data from the users as possible. This data is used to 
monetize the users by selling it to other companies. But it can also be used by governments 
to track users, even when the government said they will not do it.
</p><p>
...
that have been disabled since the creation of the list. This allows a mobile app to use the Tor
network, but only downloading 100kB per week, plus 1kB per day for the update.
</p><p>
Originally created for the NotifyMe feature of SwissCovid, lightarti-rest offers an easy-to-use
API for mobile apps. Both Android and iOS are supported. For more information, you can read
the <a href="https://github.com/c4dt/lightarti-rest/wiki">lightarti-rest wiki</a>.
</p><p>
Lightarti-rest is based on the excellent work of the new Tor-client, called arti, which is
available here:<br>
