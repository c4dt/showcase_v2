...
<p>
    With the upcoming
    <a href="https://en.wikipedia.org/wiki/Web3">Web 3.0</a>
    more and more services rely on private keys.
...
<p>
    ...
    It is a
    <a href="https://en.wikipedia.org/wiki/Threshold_cryptosystem">threshold-cryptographic</a>
    solution like the ones cited above.
...
<p>
    We looked at the
    <a href="https://www.getmonero.org/">Monero blockchain</a>,
    which provides anonymous token transfers.
    ...
    C4DT contributed to the elaboration of the protocols to be used between the client and
    the Tandem server.
    Pending to find partner support, we would like to test it on the Monero test network,
    and write a reference library in Rust.
</p>
