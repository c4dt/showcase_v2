<template>
  ...
  <p>
    ...
    <NuxtImg class="dark align-middle" src="/products/images/stainless/test-vs-fv-1.png" />
  </p>
  <p>
  ...
  <p>
    ...
    <NuxtImg class="dark align-middle" src="/products/images/stainless/test-vs-fv-2.png" />
  </p>
  <p>
    Or, failing that, you can directly obtain an image location that is incorrect:
    <NuxtImg class="dark align-middle" src="/products/images/stainless/test-vs-fv-3.png" />
  </p>
  ...
  <p>
    ...
    <NuxtImg class="dark dark_pad align-middle" src="/products/images/stainless/interactions.svg" />
  </p>
  <p>
