...
const pprintStatus = {
  [`${PROJECT_STATUS_DESC.C4DT_STATUS} ${PROJECT_STATUS.C4DT_SUPPORT_ACTIVE}`]: PROJECT_STATUS.C4DT_SUPPORT_ACTIVE,
  [`${PROJECT_STATUS_DESC.C4DT_STATUS} ${PROJECT_STATUS.C4DT_SUPPORT_RETIRED}`]: PROJECT_STATUS.C4DT_SUPPORT_RETIRED,
  [`${PROJECT_STATUS_DESC.LAB_STATUS} ${PROJECT_STATUS.LAB_MAINTENANCE_ACTIVE}`]: PROJECT_STATUS.LAB_MAINTENANCE_ACTIVE
};
